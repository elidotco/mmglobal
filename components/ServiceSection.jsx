  ...
  return (
    <div className="lg:py-20 py-10">
      ...
      <div className="flex flex-row flex-wrap py-40 gap-y-10  items-center px-5 md:px-10 lg:px-32 justify-center ">
        <div className="w-[300px]  h-[300px] lg:w-[400px] lg:h-[400px] rounded-full bg-white shadow-lg relative   justify-center overflow-hidden  text-white transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-orange-600 before:duration-500 before:ease-out hover:before:h-[300px] hover:before:w-[300px] lg:hover:before:w-[400px] lg:hover:before:h-[400px] px-6 py-3 cursor-pointer flex flex-col items-center  gap-1 ">
